...
import { StarsGenerator } from '/public/js/stars.js';
import { Planet } from '/public/js/planet.js';
import { onDOMContentLoaded, after_onClickPreviousPlanet, after_onClickNextPlanet, before_onClickPreviousPlanet, before_onClickNextPlanet } from '/public/js/scroll-text.js';
...
const sun = new Planet({ radius: 140, widthSegments: 64, heightSegments: 64 }, new THREE.Vector3(0, 0, 0), 6, {texture: '/public/textures/8k_sun.jpg'}, 1).createPlanet();
scene.add(sun);
...
// Earth
const earth = new Planet({radius: 1.27, widthSegments: 48, heightSegments: 48}, new THREE.Vector3(0, 0, 149.5 * 2), 23, {texture: '/public/textures/8k_earth_daymap.jpg', bumpMap: '/public/textures/8k_earth_bump.jpg', bumpScale: 0.3, roughness: 1, metalness: 0}).createPlanet();
// Earth's clouds
...
// Neptune
const neptune = new Planet({ radius: 5, widthSegments: 36, heightSegments: 36 }, new THREE.Vector3(0, 0, 4500), 30, {texture: '/public/textures/2k_neptune.jpg'}).createPlanet();
scene.add(neptune);
